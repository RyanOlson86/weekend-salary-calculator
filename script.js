...
function submitInfo(event) {
  ...
  //Format annualSalaryInput into currency
  let USDollar = Intl.NumberFormat("en-US", {
    style: "currency",
    currency: "USD",
  });
  annualSalaryInput = USDollar.format(annualSalaryInput);
  let monthlySalaryFormat = USDollar.format(monthlySalary);

  // Add monthlySalary to footer
  monthlySalaryPath.innerHTML = `<p>Total Monthly: ${monthlySalaryFormat}</p>`;
